...
for p in p_list:
    ...
    for n in n_list:
        ...
        run_test_case(domain=domain, pde=pde, bc=bc, n=n, p=p, ppw=ppw, kh=kh, delta_t=delta_t, num_timesteps=None, box_xlim=1.0, box_ylim=1.0, periodic_bc=False, components=False, store_sol=True, solver="mumps", assembly_type="reduced_gpu", pickle_loc=test_file)
